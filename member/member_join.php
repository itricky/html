    ...
    <td>
      ...
      <tr valign="top">
        <td><form action="" method="POST" name="formJoin" id="formJoin" onSubmit="return checkForm();">
          <p size="10" style="color:red; font-size:25px;">加入會員</p>
          <?php if(isset($_GET["errMsg"]) && ($_GET["errMsg"]=="1")){?>
            <div>帳號 <?php echo $_GET["username"];?> 已經有人使用！</div>
          <?php }?>


          <div>
            <hr size="1" />
            <p><strong>帳號資料</strong></p>
            <p><strong>使用帳號</strong>：
            <input name="m_username" type="text"  id="m_username">
            <font color="#FF0000">*</font><br><span>請填入5~12個字元以內的小寫英文字母、數字、以及_ 符號。</span></p>
            ...
            <p><strong>生　　日</strong>：
            <input name="m_birthday" type="text"  id="m_birthday">
            ...
            <p><strong>電　　話</strong>：
            <input name="m_phone" type="text"  id="m_phone"></p>

            <p><strong>住　　址</strong>：
            <input name="m_address" type="text"  id="m_address" size="40"></p>
