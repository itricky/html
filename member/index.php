...
<html>
  ...
  <body class="text-center">
	<form class="form-signin" name="form1" method="post" action="">
		...
		<input name="passwd" type="password" class="form-control" id="passwd" placeholder="請輸入密碼" value="<?php if(isset($_COOKIE["remPass"]) && ($_COOKIE["remPass"]!="")) echo $_COOKIE["remPass"];?>" required>
		...
		<br>
			<?php if(isset($_GET["errMsg"]) && ($_GET["errMsg"]=="1")){?>
				<div style="color:#D68B00;padding:10px; text-align: center;"> 
					登入帳號或密碼錯誤！
				</div>
			<?php }?>
	</form>
